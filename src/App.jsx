...
.ntab{padding:5px 14px;border-radius:7px;font-size:13px;font-weight:500;color:var(--t3);cursor:pointer;transition:all .15s;border:none;background:transparent;font-family:'Barlow',sans-serif}
...
.hero-sub{font-size:16px;color:var(--t2);max-width:520px;margin:0 auto 40px;line-height:1.6}
...
.stat-lbl{font-size:11px;color:var(--t3);margin-top:2px;text-transform:uppercase;letter-spacing:.06em}
.city-section{padding:0 24px 48px;max-width:880px;margin:0 auto;width:100%}
.section-hd{font-family:'Barlow Condensed',sans-serif;font-weight:700;font-size:13px;letter-spacing:.12em;text-transform:uppercase;color:var(--t3);margin-bottom:16px;display:flex;align-items:center;gap:8px}
...
.city-count{font-size:11px;color:var(--t3)}
...
.btn-ghost{background:transparent;color:var(--t2);border:1px solid var(--b3)}
...
.chip{padding:3px 10px;border-radius:20px;font-size:11px;font-weight:600;background:var(--s2);border:1px solid var(--b2);color:var(--t3);cursor:pointer;transition:all .15s;white-space:nowrap}
...
.sc-meta{font-size:11px;color:var(--t3);display:flex;gap:8px;flex-wrap:wrap}
...
.dg-label{font-size:11px;color:var(--t3);margin-bottom:3px;text-transform:uppercase;letter-spacing:.06em}
.dg-value{font-size:13px;font-weight:500}
.cat-breadcrumb{display:flex;align-items:center;gap:6px;font-size:12px;color:var(--t3);margin-bottom:16px;flex-wrap:wrap}
.cat-sep{color:var(--b3)}
.cat-node{color:var(--t2)}
...
.conf-title{font-size:12px;font-weight:600;color:var(--t2)}
...
.enrich-pill{padding:4px 10px;border-radius:20px;font-size:11px;background:var(--s3);border:1px solid var(--b2);color:var(--t3)}
...
.btn-out{background:transparent;color:var(--t2);border:1px solid var(--b3)}
.btn-out:hover{color:var(--t1);background:var(--s3)}
.btn-ok{background:#22c55e15;color:var(--ok);border:1px solid #22c55e25}
.empty-detail{display:flex;align-items:center;justify-content:center;height:100%;color:var(--t3);font-size:14px;flex-direction:column;gap:12px;text-align:center;padding:40px}
...
.form-sub{color:var(--t2);font-size:13px}
...
.sec-hd{font-family:'Barlow Condensed',sans-serif;font-weight:700;font-size:11px;letter-spacing:.14em;text-transform:uppercase;color:var(--t3);margin-bottom:12px;display:flex;align-items:center;gap:8px}
.sec-hd::after{content:'';flex:1;height:1px;background:var(--b1)}
.fg{display:grid;grid-template-columns:1fr 1fr;gap:12px}
.fg1{grid-template-columns:1fr}
.fg3{grid-template-columns:1fr 1fr 1fr}
.field{display:flex;flex-direction:column;gap:5px}
.fl{font-size:11px;color:var(--t3);font-weight:600;text-transform:uppercase;letter-spacing:.06em}
...
.cat-col-hd{padding:6px 10px;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.08em;color:var(--t3);background:var(--s3);border-bottom:1px solid var(--b1)}
.cat-item{padding:7px 10px;font-size:12px;color:var(--t2);cursor:pointer;transition:all .1s;border-bottom:1px solid var(--b1)}
.cat-item:hover{background:var(--s3);color:var(--t1)}
.cat-item.on{background:var(--acc)15;color:var(--acc);font-weight:600}
.cat-selected{padding:8px 12px;font-size:12px;color:var(--t2);background:var(--s1)}
...
.loc-info{flex:1}
.loc-txt{font-size:12px;color:var(--t2)}
...
.chk{display:flex;align-items:center;gap:8px;padding:7px 10px;background:var(--s2);border:1px solid var(--b1);border-radius:8px;cursor:pointer;transition:all .15s;font-size:12px;color:var(--t2)}
...
.type-tab-desc{font-size:11px;color:var(--t3);margin-top:2px}
...
.lb-sub{color:var(--t2);font-size:13px}
...
.lb-sl{font-size:11px;color:var(--t3);margin-top:2px;text-transform:uppercase;letter-spacing:.06em}
...
.lb-rank{font-family:'Barlow Condensed',sans-serif;font-weight:800;font-size:20px;width:36px;color:var(--t3);text-align:center}
...
.lb-meta{font-size:11px;color:var(--t3);margin-top:1px}
...
.prof-role{font-size:12px;color:var(--t3);margin-top:2px}
...
.prof-sl{font-size:11px;color:var(--t3);margin-top:1px}
...
.lv-pts{font-size:11px;color:var(--t3);width:56px;text-align:right}
...
.admin-nav-title{font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.12em;color:var(--t3);padding:4px 10px;margin-bottom:6px}
.anav{padding:8px 12px;border-radius:8px;font-size:13px;font-weight:500;color:var(--t3);cursor:pointer;transition:all .15s;display:flex;align-items:center;gap:8px}
.anav:hover{color:var(--t2);background:var(--s2)}
...
.admin-sub{color:var(--t2);font-size:13px}
...
.as-lbl{font-size:11px;color:var(--t3);margin-top:2px;text-transform:uppercase;letter-spacing:.06em}
...
th{padding:10px 14px;text-align:left;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.06em;color:var(--t3);border-bottom:1px solid var(--b1)}
td{padding:10px 14px;font-size:13px;border-bottom:1px solid var(--b1);color:var(--t2)}
...
.upload-sub{font-size:13px;color:var(--t2)}
...
.tmpl-desc{font-size:12px;color:var(--t3)}
.tmpl-fields{font-size:11px;color:var(--t3);margin-top:8px;line-height:1.6}
...
.dup-field-lbl{font-size:10px;color:var(--t3);text-transform:uppercase;letter-spacing:.06em}
.dup-field-val{font-size:12px;color:var(--t1)}
.dup-field-val.diff{color:var(--warn);font-weight:600}
.vs-badge{display:flex;align-items:center;justify-content:center;font-family:'Barlow Condensed',sans-serif;font-weight:800;font-size:16px;color:var(--t3);padding-top:20px}
...
.login-logo{font-family:'Barlow Condensed',sans-serif;font-weight:800;font-size:13px;letter-spacing:.14em;color:var(--t3);margin-bottom:6px;text-transform:uppercase}
...
.login-sub{color:var(--t2);font-size:13px;margin-bottom:24px;line-height:1.5}
...
.role-desc{font-size:10px;color:var(--t3);margin-top:1px}
.login-fields{display:flex;flex-direction:column;gap:12px;margin-bottom:14px}
.lf{display:flex;flex-direction:column;gap:5px}
.lf label{font-size:11px;color:var(--t3);font-weight:700;text-transform:uppercase;letter-spacing:.08em}
...
.login-sw{font-size:13px;color:var(--t2);margin-top:14px;text-align:center}
...
.mcat-count{font-size:10px;color:var(--t3)}
...
.mcat-sub{padding:4px 10px;border-radius:8px;font-size:12px;background:var(--s2);border:1px solid var(--b2);color:var(--t2);cursor:pointer;transition:all .15s}
...
.mcat-prod{padding:3px 8px;border-radius:6px;font-size:11px;background:var(--s3);border:1px solid var(--b1);color:var(--t3);cursor:pointer;transition:all .15s}
...
.cat-sub-tag{padding:2px 8px;border-radius:6px;font-size:11px;background:var(--s3);border:1px solid var(--b2);color:var(--t2)}
/* STAFF */
...
.staff-desig{font-size:12px;color:var(--t2)}
.skill-tag{padding:2px 8px;border-radius:6px;font-size:11px;background:var(--s3);border:1px solid var(--b2);color:var(--t2)}
...
.wh-card-period{font-size:11px;color:var(--t3);margin-top:2px}
/* CONTRIB VALIDATION */
...
/* THEME TOGGLE */
.theme-toggle{
  width:34px;height:20px;border-radius:10px;background:var(--s3);border:1px solid var(--b3);
  cursor:pointer;position:relative;transition:background .2s;flex-shrink:0;
}
.theme-toggle.dark{background:var(--acc)40}
.theme-knob{
  width:14px;height:14px;border-radius:50%;background:var(--t2);
  position:absolute;top:2px;left:2px;transition:all .2s;
}
.theme-toggle.dark .theme-knob{left:16px;background:var(--acc)}
...
.rewards-sub{color:var(--t2);font-size:13px}
...
.reward-pts-label{font-size:13px;color:var(--t2);margin-top:4px}
...
.sc-sub{font-size:12px;color:var(--t2);margin-bottom:16px}
...
.unlock-label{font-size:12px;color:var(--t2)}
...
.pr-meta{font-size:12px;color:var(--t2);margin-top:2px}
.pr-phone{font-size:13px;font-weight:700;color:var(--acc)}
.locked-overlay{display:flex;align-items:center;gap:8px;padding:12px;background:var(--s3);border-radius:var(--r);margin-bottom:8px;font-size:12px;color:var(--t3)}
...
.brc-detail{font-size:11px;color:var(--t2);margin-top:3px}
...
.brc-pts{font-size:11px;color:var(--t3);margin-top:2px}
...
.lc-meta{display:flex;gap:10px;flex-wrap:wrap;font-size:11px;color:var(--t3)}
...
function MultiCategorySelector({ selected, onChange }) {
  ...
  return (
    <div>
      <div style={{fontSize:11,color:"var(--t3)",marginBottom:8,fontWeight:700,textTransform:"uppercase",letterSpacing:".06em"}}>Select all categories this store carries</div>
      ...
      {selectedCats.length>0&&(
        <div>
          <div style={{fontSize:11,color:"var(--t3)",margin:"10px 0 8px",fontWeight:700,textTransform:"uppercase",letterSpacing:".06em"}}>Drill down — optional detail per category</div>
            ...
            return(
              <div key={cat} className="mcat-expanded">
                <div className="mcat-exp-title">
                  <span>📦 {cat}</span>
                  <span style={{fontSize:11,color:"var(--t3)",fontWeight:400,cursor:"pointer"}} onClick={()=>toggleCat(cat)}>× remove</span>
                </div>
                <div style={{fontSize:11,color:"var(--t3)",marginBottom:5,fontWeight:600}}>Sub-category</div>
                ...
                {curSub&&prods.length>0&&<>
                  <div style={{fontSize:11,color:"var(--t3)",marginBottom:5,fontWeight:600}}>Product Types</div>
      ...
      <div style={{background:"var(--s1)",border:"1px solid var(--b3)",borderRadius:"var(--rxl)",padding:26,maxWidth:500,width:"100%",maxHeight:"80vh",overflowY:"auto"}}>
        <div style={{display:"flex",alignItems:"center",gap:14,marginBottom:18}}>
          ...
          <div style={{flex:1}}>
            ...
            <div style={{fontSize:13,color:"var(--t2)"}}>{staff.designation}</div>
          </div>
        ...
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:18}}>
          {[["Work Email",staff.workEmail],["Personal Email",staff.personalEmail],["Phone",staff.phone],["LinkedIn",staff.linkedin||"—"]].map(([l,v])=>(
            <div key={l} style={{background:"var(--s2)",border:"1px solid var(--b1)",borderRadius:"var(--r)",padding:10}}>
              <div style={{fontSize:10,color:"var(--t3)",textTransform:"uppercase",letterSpacing:".06em",marginBottom:2}}>{l}</div>
              <div style={{fontSize:12,fontWeight:500}}>{v||"—"}</div>
            </div>
          ))}
        </div>
        <div style={{fontSize:11,fontWeight:700,textTransform:"uppercase",letterSpacing:".08em",color:"var(--t3)",marginBottom:12}}>Work History</div>
    ...
    <div style={{height:"100%",overflowY:"auto"}}>
      <div style={{maxWidth:680,margin:"0 auto",padding:"24px 20px 60px"}}>
        <div style={{marginBottom:22}}>
          ...
          <div style={{color:"var(--t2)",fontSize:13}}>Build your professional identity in the building materials industry</div>
        </div>
        ...
        <div className="sec">
          <div className="sec-hd">Work History <span style={{color:"var(--t3)",fontWeight:400,textTransform:"none",letterSpacing:0}}>— most recent first</span></div>
          {history.map((job,i)=>(
            <div key={i} style={{background:"var(--s2)",border:"1px solid var(--b2)",borderRadius:"var(--r)",padding:14,marginBottom:10}}>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10}}>
                <div style={{fontSize:12,fontWeight:700,color:"var(--t3)",textTransform:"uppercase",letterSpacing:".06em"}}>Position {i+1}{i===0?" (Current)":""}</div>
...
function DealsPage() {
  return (
    <div className="deals-pg">
      ...
      <div style={{fontSize:13,color:"var(--t3)",marginTop:12}}>Be among the first to know when deals launch.</div>
    </div>
  );
}
      ...
      <div className="rewards-wrap">
        ...
        <div className="section-card">
          ...
          <div className="unlock-counter">
            ...
            <div><div className="unlock-label">Contractor profiles unlocked</div><div style={{fontSize:11,color:"var(--t3)"}}>Next unlock in {30 - (points % 30)} points</div></div>
          </div>
            ...
            return revealed ? (
              <div key={c.id} className="profile-reveal">
                ...
                <div className="pr-info">
                  ...
                  {fullAccess && <div style={{fontSize:11,color:"var(--t2)",marginTop:2}}>{c.specialization} · {c.email||"—"}</div>}
                </div>
        ...
        <div className="section-card">
          ...
          <div className="unlock-counter">
            ...
            <div><div className="unlock-label">Architect profiles unlocked</div><div style={{fontSize:11,color:"var(--t3)"}}>Next unlock in {60 - (points % 60)} points</div></div>
          </div>
            ...
            return revealed ? (
              <div key={a.id} className="profile-reveal">
                ...
                <div className="pr-info">
                  ...
                  {fullAccess && <div style={{fontSize:11,color:"var(--t2)",marginTop:2}}>{a.specialization} · {a.email||"—"}</div>}
                </div>
                <div style={{textAlign:"right"}}>
        ...
        <div className="section-card">
          ...
          <div className="referral-card">
            <div style={{fontSize:12,color:"var(--t2)"}}>Your referral code</div>
            <div className="ref-code">{refCode}</div>
            <div style={{fontSize:12,color:"var(--t3)"}}>Share this code with colleagues in building materials industry. You earn 50 points once they are validated.</div>
          ...
          {[
            ...
            <div key={b.label} style={{display:"flex",alignItems:"center",gap:12,padding:"10px 0",borderBottom:"1px solid var(--b1)"}}>
              ...
              <div style={{flex:1}}>
                ...
                <div style={{fontSize:11,color:"var(--t3)",marginTop:1}}>{b.desc}</div>
              </div>
            ...
            <div key={c.id} style={{background:"var(--s2)",border:"1px solid var(--b2)",borderRadius:"var(--rl)",padding:16,marginBottom:14}}>
              <div style={{display:"flex",alignItems:"center",gap:14,marginBottom:14}}>
                ...
                <div style={{flex:1}}>
                  ...
                  <div style={{fontSize:12,color:"var(--t2)"}}>{c.workEmail}</div>
                </div>
